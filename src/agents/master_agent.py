...
class MasterAgent:
    ...
    def list_agents(self) -> Dict[str, str]:
        return {
            name: agent.__class__.__name__ for name, agent in self.active_agents.items()
        }
    ...
    def get_system_status(self) -> Dict[str, Any]:
        return {
            ...
            "agent_types": list(
                set(agent.__class__.__name__ for agent in self.active_agents.values())
            ),
    ...
    def execute_task(
        self, agent_name: str, task_name: str, task_params: Dict[str, Any]
    ) -> Optional[Any]:
        try:
