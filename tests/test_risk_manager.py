...
class TestRiskManager(unittest.TestCase):
    ...
    def test_calculate_position_size(self):
        ...
        size = self.risk_manager.calculate_position_size(
            account_balance=1000, entry_price=50000, stop_loss=49000
        )
        ...
        size = self.risk_manager.calculate_position_size(
            account_balance=1000, entry_price=50000, stop_loss=50000
        )
    ...
    def test_validate_trade(self):
        ...
        invalid_params = {"account_balance": 1000}
    ...
    def test_drawdown_limit(self):
        ...
        drawdown_amount = initial_balance * (
            self.config["max_drawdown"] / 100 + 0.01
        )  # Just over max drawdown
    ...
    def test_daily_loss_limit(self):
        ...
        daily_loss_amount = self.config["initial_balance"] * (
            self.config["max_daily_loss"] / 100 + 0.01
        )
